...
**NOTE**: There is currently [another power supply](https://github.com/maboytim/TRS-80_Model1_Power_Supply) being developed by Matt Boytim that appears to be smaller and cheaper. Consider using that design.
